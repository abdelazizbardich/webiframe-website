...
@section('content')
    <div class="back-page">
        <div class="back-page-header">
            <h1 class="back-page-title"><i class="fas fa-vial" aria-hidden="true"></i>{{ __('back.New Demo') }}</h1>
        </div>

        <div class="back-surface">
            @if (count($categories) > 0)
            <form action="{{ route('dashboard.demo.store') }}" enctype="multipart/form-data" method="POST" class="back-form">
                @if ($errors->any())
