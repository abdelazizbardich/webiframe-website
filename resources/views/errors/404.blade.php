...
<body>
   <section class="wrapper">
       ...
       <div class="container">
           ...
           <div class="text">
               <article>
                 <p>{{__('front.uh oh! looks like you got lost')}} <br>{{ __('front.go back to the homepage') }}</p>
                 <a href="{{route('home')}}" class="button">{{__('front.home page')}}</a>
                 <img width="100px" style="margin-top: 32px; margin-bottom:-32px" src="{{ asset('images/logo-light.png') }}" alt="logo">
               </article>
           </div>
